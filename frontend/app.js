...
(function () {
  ...
  const I18N = {
    en: {
      ...
      'teacher.revoke.button':       'Revoke ({n}s)',
      'teacher.revoke.hint':         'Misclick? Take it back within a minute.',
      'teacher.revoke.working':      'Revoking…',
      'teacher.revoke.done':         'Review revoked',
      'teacher.revoke.fail':         "Couldn't revoke — try again.",
      ...
      'about.credit.body1':    'This site builds on the original <strong>BIPH Insights</strong> — the no-code RateMyTeacher that earlier students put together on base44. The 962 reviews you see on day one were imported from there. I posted on my WeChat moments to make it clear: <strong>this isn\'t my original idea</strong> — I just rebuilt the experience. Huge thanks to whoever started it.',
      'about.credit.body2':    'I rebuilt it on a real domain (ratebiph.com, not a base44 subdomain) with a real backend because I wanted the experience to feel like a developed web product, not a hosted prototype. Faster pages, real search, anonymous reviews that actually scale, a proper mobile experience, smart search, comparison pages, shareable cards, daily auto-sync.',
      ...
      // Admin · Tools (drill-down review moderation)
      'admin.tools.title':           'Manage reviews',
      'admin.tools.lede':            'Pick a teacher to see their reviews. Click any review to hide it from the public site — hidden reviews stay visible to you so mistakes can be reversed.',
      'admin.tools.searchTeacher':   'Search teachers…',
      'admin.tools.searchComment':   'Search comments…',
      'admin.tools.noTeachers':      'No teachers match.',
      ...
      'admin.tools.back':            'Back to teachers',
      'admin.tools.reviewCountOne':  '{n} review',
      'admin.tools.reviewCountMany': '{n} reviews',
    },
    zh: {
      // Nav
      'nav.browse':      '浏览',
      ...
      'teacher.revoke.button':       '撤回（{n} 秒）',
      'teacher.revoke.hint':         '手滑了？一分钟之内还能撤回。',
      'teacher.revoke.working':      '撤回中…',
      'teacher.revoke.done':         '已撤回',
      'teacher.revoke.fail':         '撤回失败，请重试。',
      ...
      'about.credit.body1':    '本站脱胎于最初的 <strong>BIPH Insights</strong>——之前同学们在 base44 上搭的零代码版 RateMyTeacher。你看到的这 962 条初始评价就是从那边导入的。我已经在朋友圈里说明过：<strong>这个想法不是我原创的</strong>，我只是重新搭了一遍。感谢最初做这件事的人。',
      'about.credit.body2':    '我之所以重新做了一遍，是因为想要一个真正的产品体验：自己的域名（ratebiph.com，而不是 base44 的子域名），真正的后端，更快的页面，能用的搜索，可扩展的匿名评价，像样的移动端体验，AI 智能搜索，老师对比，可分享的名片，每天自动同步。',
      ...
      // Admin · Tools (drill-down review moderation)
      'admin.tools.title':           '管理评价',
      'admin.tools.lede':            '先选老师，再看该老师的评价。点击「隐藏」让评价从公开页面消失，隐藏后仍对你可见，方便撤回。',
      'admin.tools.searchTeacher':   '搜索老师…',
      'admin.tools.searchComment':   '搜索评价内容…',
      'admin.tools.noTeachers':      '没有匹配的老师。',
      ...
      'admin.tools.back':            '返回老师列表',
      'admin.tools.reviewCountOne':  '{n} 条评价',
      'admin.tools.reviewCountMany': '{n} 条评价',
    },
  };
