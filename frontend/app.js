...
(function () {
  ...
  const I18N = {
    en: {
      ...
      'home.search.go':           'Go',
      'home.search.smart':        '✨ Smart',
      'home.search.smartHint':    'Ask in plain English: "best math teacher", "easiest tests", "who gives the most homework"',
    ...
    zh: {
      ...
      'home.search.go':           '搜索',
      'home.search.smart':        '✨ 智能',
      'home.search.smartHint':    '用自然语言提问："最好的数学老师"、"考试最简单"、"作业最多的老师"',
